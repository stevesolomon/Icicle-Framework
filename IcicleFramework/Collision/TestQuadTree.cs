...
namespace Kyle0654.Components
{
    ...
    public class QuadTreeNode<T>
    {
        ...
        /// </summary>
        /// <param name="item">The index of the item to push down</param>
        ...
        /// </summary>
        /// <param name="item">The index of the item to push up</param>
    ...
    public class QuadTree<T>
    {
        ...
        /// QuadTree constructor
        /// </summary>
        /// <param name="size">The size of the QuadTree (item.e. the bottom-right with a top-left of (0,0))</param>
        /// <param name="maxItems">Maximum number of items in any cell of the QuadTree before partitioning</param>
