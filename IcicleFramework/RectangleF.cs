...
namespace IcicleFramework
{
    ...
    public struct RectangleF : IEquatable<RectangleF>
    {
        ...
        /// <returns>True if the specified rectangle intersects with this one; false if otherwise.</returns>
        public bool Intersects(RectangleF rectangle)
        {
            return
              (rectangle.X - (this.X + this.Width) < -0.001f) &&
              (rectangle.Y - (this.Y + this.Height) < -0.001f) &&
              ((rectangle.X + rectangle.Width) - this.X > 0.001f) &&
              ((rectangle.Y + rectangle.Height) - this.Y > 0.001f);
        }
        ...
        {
            return
              (this.X - other.X < 0.001f) &&
              (this.Y - other.Y < 0.001f) &&
              (this.Width - other.Width < 0.001f) &&
              (this.Height - other.Height < 0.001f);
        }
