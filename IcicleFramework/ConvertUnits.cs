...
namespace IcicleFramework
{
    ...
    public static class ConvertUnits
    {
        ...
        public static Vector2 GetTopLeftCorner(Fixture fixture, int childIndex)
        {
            Vector2 corner = Vector2.Zero;
            Transform transform;
            fixture.Body.GetTransform(out transform);
            AABB aabb;
            fixture.Shape.ComputeAABB(out aabb, ref transform, childIndex);
            
            corner.X -= aabb.Extents.X - 0.02f;
            corner.Y -= aabb.Extents.Y - 0.02f;
