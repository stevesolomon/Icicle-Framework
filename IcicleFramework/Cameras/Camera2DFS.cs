...
namespace IcicleFramework.Cameras
{
    public class Camera2DFS
    {
        ...
        public Camera2DFS(GraphicsDevice graphics)
        {

            _graphics = graphics;
            _projection = Matrix.CreateOrthographicOffCenter(0, _graphics.Viewport.Width, _graphics.Viewport.Height, 0, 0, 1);
            Matrix halfPixelOffset = Matrix.CreateTranslation(-0.5f, -0.5f, 0);

            _projection = halfPixelOffset * _projection;

            _view = Matrix.Identity;
            _batchView = Matrix.Identity;

            _translateCenter = Vector2.Zero;
